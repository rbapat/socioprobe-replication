...
if __name__ == '__main__':
    ...
    # ELECTRA
    nps_electra_f1_scores_layerall = model_pipeline("google/electra-base-discriminator", "CoLA_clean.csv", verbose=True)
    ...
    nps_electra_f1_scores_layer1 = model_pipeline("google/electra-base-discriminator", "CoLA_clean.csv", layer=1, verbose=True)
    ...
    nps_roberta_f1_scores = model_pipeline("roberta-base", "CoLA_clean.csv", verbose=True)
